 ...
 * 
 * Comparators only allow two objects to be compared in entierity. This provides a generic way of comparing two JavaBeans by specifying their property name and the appropriate values are computed dynamically at run time.
 * 
 * Example of use:
 * 
 * <PRE>
 ...
 * }
 * 
 * Comparator c = new BeanPropertyComparator(&quot;name&quot;); // returns -1 c.compare(new PersonBean(&quot;Alex&quot;),new PersonBean(&quot;Bob&quot;));
 * // returns 0 c.compare(new PersonBean(&quot;Alex&quot;),new PersonBean(&quot;Alex));
 * // returns 1 c.compare(new PersonBean(&quot;Bob&quot;),new PersonBean(&quot;Bob&quot;));
 * </PRE>
 * 
 * <B>Note </B> the <I>property </I> is the name of a JavaBeans property, and according to the JavaBeans specification must start with a lower case letter. So, the property <CODE>name</CODE> is translated to the method <CODE>getName()</CODE> using the
 * standard {@link java.beans.Introspector}process.
 * <P>
 * <B>Note </B> this uses the {@link java.beans.BeanInfo}class to obtain the accessor method, so that provided a {@link java.beans.BeanInfo}is given, it will work regardless of the name of the read method.
 * 
...
public class BeanPropertyComparator implements Comparator {
	 ...
	 * 
	 * Property names must start with a lower-case letter as per the JavaBeans specification. This uses {@link java.beans.Introspector introspection}to obtain the property dynamically from its access method.
	 * 
	 ...
	 * 
	 * If no {@link java.util.Comparator}is given during construction, and either <CODE>o1</CODE> or <CODE>o2</CODE> implements {@link java.lang.Comparable}, then it is cast to {@link java.lang.Comparable}and compared with the other.
	 * 
	 * If no {@link java.util.Comparator}is given, and neither <CODE>o1</CODE> or <CODE>o2</CODE> implement {@link java.lang.Comparable}then the objects are converted to a <CODE>String</CODE> using the {@link java.lang.String#valueOf}method (which calls
	 * {@link java.lang.Object#toString}), and standard <CODE>String</CODE> comparison is performed.
	 * 
	 * @param o1
